...
<style scoped>
.research-summary { flex: none; max-height: 35%; min-height: 200px; overflow: auto; padding: 14px 20px; border-top: 1px solid var(--line); @apply bg-raised; }.research-workspace { height: 100%; min-height: 0; display: flex; flex-direction: column; @apply text-ink-900 bg-app; }
...
.research-header { padding: 18px 22px; border-bottom: 1px solid var(--line); @apply bg-raised; }.research-header > div { margin-right: auto; }.research-header h2 { margin: 0; font-size: 19px; }.research-header p { margin: 5px 0 0; font-size: 12px; @apply text-ink-500; }
button, input { font: inherit; font-size: 12px; @apply text-ink-900; }button { display: inline-flex; align-items: center; justify-content: center; gap: 5px; padding: 7px 10px; min-height: 34px; border: 1px solid var(--line); border-radius: 6px; @apply bg-raised; cursor: pointer; }button:disabled { opacity: .55; cursor: default; }.primary { @apply text-white bg-accent-solid border-accent; }input { padding: 8px; border: 1px solid var(--line); border-radius: 5px; @apply bg-input; }input[type="checkbox"] { accent-color: var(--green-700); }
.research-query { flex-wrap: wrap; padding: 15px 20px; align-items: end; border-bottom: 1px solid var(--line); }.research-query label { display: flex; flex-direction: column; gap: 5px; font-size: 11px; @apply text-ink-500; }.query-text { flex: 1; min-width: 170px; }.research-query input[type="number"] { width: 68px; }.research-query .check-option { flex-direction: row; align-items: center; min-height: 34px; }
.research-history { padding: 8px 20px; font-size: 12px; border-bottom: 1px solid var(--line); }.research-history select { margin-left: 8px; }.research-run { flex-wrap: wrap; padding: 10px 20px; font-size: 11px; @apply text-ink-500; border-bottom: 1px solid var(--line); }.research-run strong { font-weight: 500; @apply text-ink-900; }.research-body { flex: 1; min-height: 0; display: grid; grid-template-columns: minmax(240px, 43%) minmax(280px, 1fr); }.research-results { display: flex; flex-direction: column; min-height: 0; border-right: 1px solid var(--line); }.research-viewport { flex: 1; min-height: 0; overflow: auto; }.research-row { display: block; text-align: left; padding: 18px 28px 18px 18px; border-radius: 0; border-width: 0 0 1px; min-height: 130px; line-height: 1.7; }.research-row.selected { @apply bg-green-soft; box-shadow: inset 3px 0 var(--green-700); }.research-row p { margin: 8px 0; overflow-wrap: anywhere; }.research-row small { font-size: 11px; @apply text-ink-500; }.research-row > svg { position: absolute; right: 9px; top: 30px; }.candidate-summary { @apply text-ink-500; }.research-review { overflow: auto; padding: 20px; outline-offset: -3px; }.research-review header { justify-content: space-between; flex-wrap: wrap; }.research-review h3 { margin: 0; font-size: 15px; }.review-source { line-height: 1.8; padding-bottom: 14px; border-bottom: 1px solid var(--line); }.target-text p { margin: 15px 0; line-height: 1.9; white-space: pre-wrap; overflow-wrap: anywhere; }.research-help, .research-review > small { @apply text-ink-500; font-size: 11px; line-height: 1.7; }.research-review > label { display: flex; flex-direction: column; gap: 7px; margin-top: 17px; font-size: 12px; }.review-actions { margin-top: 20px; flex-wrap: wrap; }.candidate-options { display: flex; flex-wrap: wrap; gap: 6px; margin: 10px 0; }.research-notice, .research-error { margin: 0; padding: 10px 20px; font-size: 12px; line-height: 1.7; @apply bg-green-soft; }.research-error { @apply text-ink-900; }.research-notice button, .research-error button { margin-left: 8px; }.research-empty { margin: auto; padding: 32px; text-align: center; @apply text-ink-500; }.research-empty-text { padding: 28px; font-size: 13px; @apply text-ink-500; line-height: 1.8; }.saved-status { font-size: 12px; @apply text-accent-strong; }
.research-row small.review-required, .saved-status.review-required { @apply text-ink-900; font-weight: 600; }
