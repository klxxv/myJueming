...
import { Check, MessageSquareText, Pencil, Plus, Save, Trash2, X } from "@lucide/vue";
...
<style scoped>
.annotation-workspace { display: flex; flex-direction: column; width: 355px; height: 100%; min-height: 0; overflow: hidden; border-left: 1px solid #ccd9cd; color: var(--ink-900); background: #fbfdfb; box-shadow: -12px 0 30px rgb(32 51 35 / 10%); }.annotation-heading { display: flex; align-items: flex-start; justify-content: space-between; padding: 19px 18px 12px; }.annotation-heading button { padding: 5px; border: 0; color: var(--ink-500); background: transparent; cursor: pointer; }.annotation-eyebrow { color: var(--green-700); font-size: 10px; font-weight: 700; letter-spacing: .1em; }.annotation-heading h2 { margin: 4px 0 0; font-size: 16px; }.annotation-heading h2 small { display: inline-block; margin-left: 3px; padding: 2px 6px; border-radius: 10px; color: var(--green-900); background: var(--green-100); font-size: 11px; }.annotation-filter { display: flex; gap: 4px; padding: 0 13px 13px; border-bottom: 1px solid var(--line); }.annotation-filter button { padding: 7px 8px; border: 1px solid transparent; border-radius: 5px; color: var(--ink-500); background: transparent; font-size: 12px; cursor: pointer; }.annotation-filter button.active { border-color: #b3d5b7; color: var(--green-900); background: #f3faf1; }.annotation-filter span { margin-left: 2px; color: var(--ink-500); }.annotation-list { min-height: 0; overflow: auto; padding-bottom: 4px; }.annotation-card { display: grid; grid-template-columns: 25px 1fr; gap: 7px; margin: 13px 13px 0; padding: 13px 11px; border: 1px solid #d3dde5; border-radius: 8px; background: #fff; cursor: pointer; }.annotation-card--selected { outline: 2px solid rgb(47 129 67 / 20%); }.annotation-card--draft { border-color: #d3c4ec; }.annotation-card--resolved { opacity: .78; }.annotation-number { display: grid; place-items: center; width: 22px; height: 22px; border-radius: 6px; color: #fff; background: #9864d5; font-size: 12px; }.annotation-number.annotation-status--in_progress { background: #3c9a5a; }.annotation-number.annotation-status--resolved { background: #7d877f; }.annotation-state { display: flex; align-items: center; gap: 7px; color: var(--ink-900); font-size: 12px; font-weight: 650; }.annotation-state > span:nth-child(2) { color: var(--ink-500); font-weight: 500; }.annotation-state time { margin-left: auto; color: var(--ink-500); font-size: 10px; font-weight: 400; }.annotation-state-pill { padding: 3px 6px; border-radius: 4px; color: #fff; background: #9864d5; }.annotation-state-pill.annotation-status--in_progress { background: #3c9a5a; }.annotation-state-pill.annotation-status--resolved { background: #7d877f; }.annotation-card h3 { margin: 12px 0 7px; font-size: 14px; }.annotation-card p { margin: 0; color: var(--ink-700); font-size: 12px; line-height: 1.55; }.annotation-links { display: flex; flex-direction: column; gap: 5px; margin-top: 10px; padding: 8px; border-radius: 5px; background: #f8faf8; color: var(--ink-700); font-size: 11px; }.annotation-links b { float: right; color: var(--ink-500); font-weight: 500; }.annotation-links small { display: block; color: var(--ink-700); }.annotation-card-actions { display: flex; flex-wrap: wrap; gap: 12px; margin-top: 10px; padding-top: 9px; border-top: 1px solid var(--line); }.annotation-card-actions button, .annotation-new { display: inline-flex; align-items: center; gap: 5px; border: 0; color: var(--ink-700); background: transparent; font-size: 12px; cursor: pointer; }.annotation-card-actions button:hover { color: var(--green-900); }.annotation-resolve { color: var(--green-900) !important; }.annotation-new { justify-content: center; margin: 13px; padding: 10px; border: 1px solid #abd1af; border-radius: 6px; color: var(--green-900); background: #f4fbf2; }.annotation-editor { display: grid; gap: 8px; }.annotation-editor--new { margin: 13px; padding: 13px; border: 1px solid #abd1af; border-radius: 7px; background: #f4fbf2; }.annotation-editor-title { display: flex; align-items: center; gap: 7px; color: var(--green-900); }.annotation-editor-title button { margin-left: auto; padding: 2px; border: 0; color: var(--ink-500); background: transparent; cursor: pointer; }.annotation-editor label { display: grid; gap: 4px; color: var(--ink-700); font-size: 11px; }.annotation-editor input, .annotation-editor textarea, .annotation-editor select { width: 100%; border: 1px solid #c8d3c9; border-radius: 4px; padding: 7px; color: var(--ink-900); background: #fff; font-size: 12px; }.annotation-editor textarea { resize: vertical; }.annotation-editor footer { display: flex; justify-content: flex-end; gap: 7px; margin-top: 2px; }.annotation-primary, .annotation-secondary { display: inline-flex; align-items: center; gap: 5px; padding: 7px 11px; border: 1px solid var(--line); border-radius: 5px; background: #fff; cursor: pointer; }.annotation-primary { border-color: var(--green-700); color: #fff; background: var(--green-700); }.annotation-empty { display: flex; align-items: center; justify-content: center; gap: 7px; min-height: 90px; color: var(--ink-500); font-size: 12px; }
</style>
