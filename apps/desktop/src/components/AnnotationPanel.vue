...
<style scoped>
.annotation-workspace { display: flex; width: 100%; height: 100%; min-width: 0; min-height: 0; flex-direction: column; overflow: hidden; border: 1px solid var(--line); border-right: 0; border-radius: 0; @apply text-ink-900 bg-subtle; box-shadow: var(--shadow-soft); }.annotation-heading { display: flex; align-items: flex-start; justify-content: space-between; padding: 19px 18px 12px; }.annotation-heading button { padding: 5px; border: 0; @apply text-ink-500; background: transparent; cursor: pointer; }.annotation-eyebrow { @apply text-accent; font-size: var(--jm-font-size-subheadline); font-weight: var(--jm-font-weight-semibold); letter-spacing: .1em; line-height: var(--jm-line-height-subheadline); }.annotation-heading h2 { margin: 4px 0 0; font-size: var(--jm-font-size-title-3); line-height: var(--jm-line-height-title-3); font-weight: var(--jm-font-weight-semibold); }.annotation-heading h2 small { display: inline-block; margin-left: 3px; padding: 2px 6px; border-radius: 10px; @apply text-accent-strong bg-accent-soft; font-size: var(--jm-font-size-subheadline); line-height: var(--jm-line-height-subheadline); }.annotation-filter { display: flex; gap: 4px; padding: 0 13px 13px; border-bottom: 1px solid var(--line); }.annotation-filter button { padding: 7px 8px; border: 1px solid transparent; border-radius: 5px; @apply text-ink-500; background: transparent; font-size: var(--jm-font-size-callout); cursor: pointer; line-height: var(--jm-line-height-callout); }.annotation-filter button.active { border-color: #b3d5b7; @apply text-accent-strong bg-green-selected; }.annotation-filter span { margin-left: 2px; @apply text-ink-500; }.annotation-list { min-height: 0; overflow: auto; padding-bottom: 4px; }.annotation-card { display: grid; grid-template-columns: 25px 1fr; gap: 7px; margin: 13px 13px 0; padding: 13px 11px; border: 1px solid #d3dde5; border-radius: 8px; @apply bg-raised; cursor: pointer; }.annotation-card--selected { outline: 2px solid rgb(47 129 67 / 20%); }.annotation-card--draft { border-color: #d3c4ec; }.annotation-card--resolved { opacity: .78; }.annotation-number { display: grid; place-items: center; width: 22px; height: 22px; border-radius: 6px; color: #fff; background: #9864d5; font-size: var(--jm-font-size-callout); line-height: var(--jm-line-height-callout); }.annotation-number.annotation-status--in_progress { background: #3c9a5a; }.annotation-number.annotation-status--resolved { background: #7d877f; }.annotation-state { display: flex; align-items: center; gap: 7px; @apply text-ink-900; font-size: var(--jm-font-size-callout); font-weight: var(--jm-font-weight-semibold); line-height: var(--jm-line-height-callout); }.annotation-state time { margin-left: auto; @apply text-ink-500; font-size: var(--jm-font-size-subheadline); font-weight: var(--jm-font-weight-regular); line-height: var(--jm-line-height-subheadline); }.annotation-state-pill { padding: 3px 6px; border-radius: 4px; color: #fff; background: #9864d5; }.annotation-state-pill.annotation-status--in_progress { background: #3c9a5a; }.annotation-state-pill.annotation-status--resolved { background: #7d877f; }.annotation-card h3 { margin: 12px 0 7px; font-size: var(--jm-font-size-body); line-height: var(--jm-line-height-body); font-weight: var(--jm-font-weight-semibold); }.annotation-card p { margin: 0; @apply text-ink-700; font-size: var(--jm-font-size-body); line-height: 1.55; }.annotation-links { display: flex; flex-direction: column; gap: 5px; margin-top: 10px; padding: 8px; border-radius: 5px; @apply bg-muted text-ink-700; font-size: var(--jm-font-size-subheadline); line-height: var(--jm-line-height-subheadline); }.annotation-links b { float: right; @apply text-ink-500; font-weight: var(--jm-font-weight-medium); }.annotation-links small { display: block; @apply text-ink-700; }.annotation-card-actions { display: flex; flex-wrap: wrap; gap: 12px; margin-top: 10px; padding-top: 9px; border-top: 1px solid var(--line); }.annotation-card-actions button, .annotation-new { display: inline-flex; align-items: center; gap: 5px; border: 0; @apply text-ink-700; background: transparent; font-size: var(--jm-font-size-callout); cursor: pointer; line-height: var(--jm-line-height-callout); }.annotation-card-actions button:hover { @apply text-accent-strong; }.annotation-resolve { color: var(--green-900) !important; }.annotation-new { justify-content: center; margin: 13px; padding: 10px; border: 1px solid #abd1af; border-radius: 6px; @apply text-accent-strong bg-green-soft; }.annotation-editor { display: grid; gap: 8px; }.annotation-editor--new { margin: 13px; padding: 13px; border: 1px solid #abd1af; border-radius: 7px; @apply bg-green-soft; }.annotation-editor-title { display: flex; align-items: center; gap: 7px; @apply text-accent-strong; }.annotation-editor-title button { margin-left: auto; padding: 2px; border: 0; @apply text-ink-500; background: transparent; cursor: pointer; }.annotation-editor label { display: grid; gap: 4px; @apply text-ink-700; font-size: var(--jm-font-size-body); line-height: var(--jm-line-height-body); }.annotation-editor select { width: 100%; }
.annotation-editor input, .annotation-editor textarea { width: 100%; padding: 7px; border: 1px solid #c8d3c9; border-radius: 4px; @apply text-ink-900 bg-input; font-size: var(--jm-font-size-body); line-height: var(--jm-line-height-body); }.annotation-editor textarea { resize: vertical; }.annotation-editor footer { display: flex; justify-content: flex-end; gap: 7px; margin-top: 2px; }.annotation-primary, .annotation-secondary { display: inline-flex; align-items: center; gap: 5px; padding: 7px 11px; border: 1px solid var(--line); border-radius: 5px; @apply bg-raised; cursor: pointer; }.annotation-primary { @apply border-accent; color: #fff; @apply bg-accent-solid; }.annotation-empty { display: flex; min-height: 90px; align-items: center; justify-content: center; gap: 7px; @apply text-ink-500; font-size: var(--jm-font-size-callout); line-height: var(--jm-line-height-callout); }
...
.annotation-links button:hover { @apply text-accent-strong bg-green-soft; }
