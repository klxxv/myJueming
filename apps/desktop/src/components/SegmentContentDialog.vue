...
<style scoped>
.content-operation-backdrop { position: fixed; z-index: 100; inset: 0; display: grid; place-items: center; background: rgb(31 42 34 / 25%); }.content-operation-dialog { display: flex; flex-direction: column; width: min(620px, calc(100vw - 48px)); max-height: min(680px, calc(100vh - 64px)); padding: 20px; border: 1px solid var(--line); border-radius: 10px; @apply text-ink-900 bg-raised; box-shadow: 0 22px 70px rgb(29 48 32 / 23%); }.content-operation-dialog header, .content-operation-dialog footer { display: flex; align-items: center; justify-content: space-between; }.content-operation-dialog header small { @apply text-accent; font-size: var(--jm-font-size-subheadline); font-weight: var(--jm-font-weight-semibold); letter-spacing: .08em; line-height: var(--jm-line-height-subheadline); }.content-operation-dialog header h2 { margin: 4px 0 0; font-size: var(--jm-font-size-title-2); line-height: var(--jm-line-height-title-2); font-weight: var(--jm-font-weight-regular); }.content-operation-dialog header button { border: 0; @apply text-ink-500; background: transparent; cursor: pointer; }.content-operation-dialog > p { margin: 14px 0 10px; @apply text-ink-700; font-size: var(--jm-font-size-body); line-height: 1.55; }.content-operation-dialog textarea { flex: 1; min-height: 220px; resize: vertical; padding: 11px; border: 1px solid #bfcdbf; border-radius: 6px; @apply text-ink-900 bg-paper; font: inherit; line-height: 1.6; }.content-operation-dialog textarea:focus { @apply border-accent; outline: 2px solid rgb(55 127 66 / 14%); }.split-validation { display: flex; align-items: center; gap: 10px; margin-top: 10px; color: var(--text-warning, #916714); font-size: var(--jm-font-size-callout); line-height: var(--jm-line-height-callout); }.split-validation button { padding: 6px 8px; border: 1px solid #c4d0c5; border-radius: 5px; @apply text-accent-strong bg-raised; cursor: pointer; }.split-validation--valid { @apply text-accent; }.content-operation-dialog footer { gap: 9px; margin-top: 17px; justify-content: flex-end; }
</style>
