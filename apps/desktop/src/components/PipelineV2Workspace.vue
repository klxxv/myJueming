...
<style scoped>
.pipeline-v2 { display: flex; flex-direction: column; height: 100%; min-height: 0; color: var(--ink-900); background: var(--surface-app); }.v2-toolbar, .v2-methods, .v2-add, .v2-node header, .v2-run header { display: flex; align-items: center; gap: 10px; }.v2-toolbar { flex-wrap: wrap; padding: 15px 20px; border-bottom: 1px solid var(--line); background: var(--surface-raised); }.v2-toolbar > div { margin-right: auto; }.v2-toolbar h2 { margin: 0; font-size: 18px; }.v2-toolbar p { margin: 4px 0 0; color: var(--ink-500); font-size: 11px; }button, input, textarea { font: inherit; color: var(--ink-900); font-size: 12px; }button { display: inline-flex; align-items: center; justify-content: center; gap: 5px; min-height: 32px; padding: 6px 10px; background: var(--surface-raised); border: 1px solid var(--line); border-radius: 6px; cursor: pointer; }button:disabled { opacity: .55; cursor: default; }.primary { color: var(--paper); border-color: var(--green-700); background: var(--green-700); }input, textarea { min-width: 0; padding: 7px; border: 1px solid var(--line); border-radius: 5px; background: var(--surface-input); }textarea { resize: vertical; font-family: ui-monospace, monospace; line-height: 1.7; }.v2-methods { flex-wrap: wrap; padding: 10px 20px; border-bottom: 1px solid var(--line); font-size: 11px; color: var(--ink-500); }.v2-methods select { margin-left: 6px; }.v2-content { flex: 1; min-height: 0; display: grid; grid-template-columns: minmax(360px, 1fr) 270px; }.v2-editor { overflow: auto; padding: 18px 20px; }.v2-name, .v2-node > label { display: flex; flex-direction: column; gap: 7px; margin-bottom: 12px; font-size: 12px; }.v2-add { margin: 16px 0; }.v2-add select { flex: 1; width: 0; }.v2-node { padding: 14px; margin-bottom: 14px; border: 1px solid var(--line); border-radius: 10px; background: var(--surface-raised); outline-offset: 3px; }.v2-node header { justify-content: space-between; margin-bottom: 12px; font-size: 13px; }.v2-input { padding: 10px 0; border-top: 1px solid var(--line); }.v2-input > div { display: flex; gap: 7px; flex-wrap: wrap; align-items: center; font-size: 11px; margin-bottom: 7px; }.v2-input > select { display: block; width: 100%; margin-bottom: 6px; }.v2-input span, .v2-help, .v2-ports, .v2-empty { color: var(--ink-500); font-size: 11px; line-height: 1.8; }.v2-ports > span { display: block; }.schema-link { display: inline; min-height: 24px; padding: 2px 4px; border: 0; color: var(--green-900); font-size: 10px; background: transparent; text-align: left; }.v2-outputs { padding: 12px; border: 1px solid var(--line); border-radius: 8px; font-size: 12px; }.v2-outputs label { display: flex; align-items: center; gap: 8px; margin: 8px 0; overflow-wrap: anywhere; }.v2-outputs input { accent-color: var(--green-700); }.v2-validation { font-size: 12px; line-height: 1.8; color: var(--green-900); }.v2-catalog { overflow: auto; border-left: 1px solid var(--line); padding: 14px; background: var(--surface-raised); }.v2-catalog summary { cursor: pointer; font-size: 12px; }.v2-catalog ul, .v2-run ul { margin: 0; padding: 0; list-style: none; }.v2-catalog li { padding: 10px 0; border-bottom: 1px solid var(--line); }.v2-catalog li > strong { display: block; font-size: 11px; overflow-wrap: anywhere; }.v2-catalog li > span, .v2-catalog li > p { font-size: 11px; color: var(--ink-500); margin: 5px 0; }.v2-schema h3 { font-size: 12px; }.v2-schema pre { font-size: 10px; overflow: auto; max-height: 350px; }.v2-notice { padding: 10px 20px; margin: 0; background: var(--surface-green-soft); font-size: 12px; }.v2-empty { padding: 30px; }.v2-run { flex: none; max-height: 26%; min-height: 90px; padding: 12px 20px; overflow: auto; border-top: 1px solid var(--line); background: var(--surface-raised); font-size: 11px; }.v2-run header { flex-wrap: wrap; }.v2-run li { display: grid; grid-template-columns: 160px minmax(130px, 1fr); gap: 4px 12px; padding: 10px 0; border-top: 1px solid var(--line); margin-top: 10px; }.v2-run code { overflow-wrap: anywhere; }.v2-run small { color: var(--ink-500); }@media(max-width:1100px) { .v2-content { grid-template-columns: minmax(320px, 1fr) 220px; }.v2-editor { padding: 12px; }.v2-toolbar { padding: 12px; } }
</style>
