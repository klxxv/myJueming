...
<style scoped>
.pipeline-surfaces { display: flex; flex: none; gap: 6px; padding: 8px 20px; border-bottom: 1px solid var(--line); @apply bg-raised; }.pipeline-surfaces button[aria-pressed="true"] { @apply text-accent-strong bg-green-soft border-accent; }.pipeline-workspace > .pipeline-v2 { flex: 1; height: auto; min-height: 0; }
.pipeline-workspace { display: flex; height: 100%; min-height: 0; flex-direction: column; @apply text-ink-900 bg-app; }.pipeline-header { display: flex; min-height: 74px; align-items: center; gap: 10px; padding: 12px 22px; border-bottom: 1px solid var(--line); @apply bg-raised; }.pipeline-title { display: flex; gap: 12px; align-items: center; margin-right: auto; @apply text-accent-strong; }.pipeline-title h2 { margin: 0; font-size: 19px; }.pipeline-title p { margin: 3px 0 0; @apply text-ink-500; font-size: 11px; }.method-version { font-size: 11px; @apply text-ink-500; }.pipeline-workspace button { display: inline-flex; align-items: center; justify-content: center; gap: 6px; min-height: 32px; padding: 6px 10px; border: 1px solid var(--line); border-radius: 6px; @apply bg-raised; font-size: 12px; cursor: pointer; }.pipeline-workspace button.pipeline-run { @apply text-white bg-accent-solid border-accent; }.pipeline-word-form input { min-width: 0; padding: 7px 9px; border: 1px solid var(--line); border-radius: 6px; @apply bg-input text-ink-900; font-size: 12px; }.pipeline-empty { margin: auto; padding: 30px; text-align: center; @apply text-ink-500; max-width: 480px; }.pipeline-empty h3 { @apply text-ink-900; font-size: 18px; }.pipeline-empty p { font-size: 13px; line-height: 1.8; }.pipeline-method-bar { display: flex; align-items: center; gap: 16px; padding: 12px 20px; font-size: 11px; @apply text-ink-500; border-bottom: 1px solid var(--line); }.pipeline-body { flex: 1; min-height: 220px; display: grid; grid-template-columns: minmax(0, 1fr) 240px; }.pipeline-canvas { position: relative; background-image: radial-gradient(var(--line) 1px, transparent 1px); background-size: 18px 18px; min-width: 0; }.pipeline-fit { position: absolute; left: 14px; bottom: 14px; }.pipeline-node { width: 200px; padding: 18px; border: 1px solid var(--line); border-radius: 12px; @apply bg-raised; box-shadow: 0 3px 12px rgb(35 55 38 / 5%); }.pipeline-node--selected { border: 2px solid var(--green-700); padding: 17px; }.pipeline-node__icon { width: 36px; height: 36px; display: grid; place-items: center; border-radius: 10px; @apply text-accent bg-green-soft; }.pipeline-node strong, .pipeline-node small { display: block; }.pipeline-node strong { margin: 12px 0 5px; font-size: 14px; }.pipeline-node small { @apply text-ink-500; font-size: 11px; }.pipeline-canvas :deep(.vue-flow__edge-path) { stroke: var(--green-700); stroke-width: 1.5; }.pipeline-canvas :deep(.vue-flow__handle) { width: 6px; height: 6px; @apply bg-accent; border: 2px solid var(--surface-raised); }.pipeline-inspector { overflow-y: auto; padding: 20px 16px; border-left: 1px solid var(--line); @apply bg-raised; }.pipeline-eyebrow { @apply text-ink-500; font-size: 11px; }.pipeline-inspector h3 { margin: 10px 0 22px; font-size: 16px; }.pipeline-inspector h4 { margin: 24px 0 7px; font-size: 13px; }.pipeline-inspector p { @apply text-ink-500; font-size: 11px; line-height: 1.7; }.pipeline-check { display: flex; align-items: center; gap: 8px; padding: 8px 0; font-size: 12px; }.pipeline-check input { accent-color: var(--green-700); }.pipeline-word-form { display: flex; gap: 6px; }.pipeline-word-form input { width: 100%; }.pipeline-dictionary { padding: 0; list-style: none; }.pipeline-dictionary li { display: flex; justify-content: space-between; align-items: center; padding: 6px 0; border-bottom: 1px solid var(--line); font-size: 12px; }.pipeline-dictionary button { border: 0; }.pipeline-result { max-height: 32%; min-height: 150px; padding: 16px 20px; overflow-y: auto; border-top: 1px solid var(--line); @apply bg-raised; }.pipeline-result header { display: flex; gap: 15px; align-items: center; justify-content: space-between; margin-bottom: 14px; }.pipeline-result header strong { font-size: 13px; white-space: nowrap; }.pipeline-result select { max-width: 75%; }.pipeline-result p, .pipeline-result small { @apply text-ink-500; font-size: 11px; }.pipeline-tokens { display: flex; flex-wrap: wrap; gap: 5px; margin-top: 12px; }.pipeline-tokens span { padding: 5px 8px; border: 1px solid var(--line); border-radius: 5px; font-size: 12px; @apply bg-green-soft text-accent-strong; }.pipeline-notice { display: flex; justify-content: space-between; align-items: center; margin: 0; padding: 8px 16px; @apply bg-green-soft; font-size: 12px; line-height: 1.6; }
