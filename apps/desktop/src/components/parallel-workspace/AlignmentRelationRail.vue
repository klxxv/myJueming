...
const quickActionLabel = computed(() => props.block.linked
  ? t('quickUnlink', { p0: relationLabel.value })
  : t('quickLink', { p0: relationKind.value }));
</script>
  ...
  >
    ...
    <div class="alignment-relation__pill">
      <button
        ...
        :aria-label="block.linked ? t('selectItem', { p0: relationLabel }) : t('selectUnalignedBlock')"
        :title="block.linked ? t('selectAlignmentHint') : t('selectUnalignedSides')"
