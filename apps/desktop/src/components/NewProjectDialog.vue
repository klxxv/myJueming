...
.import-modal { display: flex; flex-direction: column; width: min(1040px, 100%); height: min(820px, calc(100dvh - 48px)); max-height: 100%; min-height: 0; overflow: hidden; border: 1px solid var(--line); border-radius: 12px; @apply text-ink-900 bg-raised; box-shadow: 0 22px 70px rgb(29 48 32 / 23%); }
...
.wizard-header { border-bottom: 1px solid var(--line); }.wizard-header h2 { margin: 5px 0 0; }.eyebrow { @apply text-accent; font-size: var(--jm-font-size-subheadline); line-height: var(--jm-line-height-subheadline); }
.icon-button { display: inline-flex; flex: none; align-items: center; justify-content: center; width: 34px; height: 34px; padding: 0; border: 0; border-radius: 6px; @apply text-ink-500; background: transparent; cursor: pointer; }.icon-button:hover:not(:disabled) { @apply text-ink-900 bg-hover; }
.wizard-body { flex: 1; display: grid; grid-template-columns: 210px minmax(0, 1fr); min-height: 0; }
.wizard-navigation { display: flex; flex-direction: column; gap: 14px; padding: 20px 14px; border-right: 1px solid var(--line); overflow: auto; @apply bg-subtle; }.wizard-navigation ol { display: grid; gap: 5px; padding: 0; margin: 0; list-style: none; }.wizard-navigation .step-link { display: flex; align-items: center; gap: 11px; flex: 1; min-width: 0; min-height: 58px; padding: 9px 10px; text-align: left; border: 1px solid transparent; border-radius: 8px; background: transparent; cursor: pointer; }.wizard-navigation .step-link[aria-current="step"] { @apply border-line text-accent-strong bg-green-selected; }.wizard-navigation .step-link:hover:not(:disabled) { @apply bg-hover; }.wizard-navigation .step-link:disabled { opacity: .6; }
...
.wizard-navigation .remove-step:hover:not(:disabled) { @apply bg-danger-soft; }
.step-number { display: inline-flex; flex: none; align-items: center; justify-content: center; width: 25px; height: 25px; border: 1px solid var(--line); border-radius: 50%; @apply text-ink-500 bg-raised; font-size: var(--jm-font-size-callout); }[aria-current="step"] .step-number { @apply border-accent text-accent-strong; }.step-text { display: grid; min-width: 0; gap: 5px; }.step-text strong { font-size: var(--jm-font-size-body); }.step-text small { overflow: hidden; white-space: nowrap; text-overflow: ellipsis; @apply text-ink-500; }
.add-translation { display: flex; align-items: center; justify-content: center; flex: none; gap: 7px; min-height: 38px; padding: 8px; border: 1px solid var(--line); border-radius: 7px; @apply text-accent-strong bg-raised; cursor: pointer; }.wizard-navigation > p { margin: 0; padding: 0 7px; @apply text-ink-500; font-size: var(--jm-font-size-callout); line-height: 1.7; }
.wizard-content { min-width: 0; overflow: auto; overscroll-behavior: contain; padding: 25px 28px; }.wizard-page { display: flex; flex-direction: column; gap: 17px; min-width: 0; }.step-intro { margin-bottom: 3px; }.step-caption { @apply text-ink-500; font-size: var(--jm-font-size-callout); }.step-intro h3 { margin: 8px 0; font-size: var(--jm-font-size-title-2); line-height: var(--jm-line-height-title-2); }.step-intro h3:focus { outline: none; }.step-intro p { margin: 0; @apply text-ink-700; line-height: 1.7; }
.field-label { display: grid; gap: 8px; min-width: 0; @apply text-ink-700; }.field-label > input, .compact-picker { min-width: 0; height: 38px; border: 1px solid var(--line); border-radius: 7px; @apply text-ink-900 bg-input; }.field-label > input { width: 100%; padding: 0 11px; }.compact-picker { display: flex; align-items: center; gap: 8px; padding-left: 11px; }.compact-picker > svg { flex: none; @apply text-ink-500; }.compact-picker input { flex: 1; min-width: 0; width: 100%; height: 100%; padding: 0; border: 0; border-radius: 0; @apply text-ink-900; background: transparent; }.compact-picker button { align-self: stretch; flex: none; padding: 0 13px; border: 0; border-left: 1px solid var(--line); border-radius: 0 6px 6px 0; @apply text-accent-strong bg-subtle; cursor: pointer; }.save-path { margin: -5px 0 0; @apply text-ink-500; font-size: var(--jm-font-size-callout); line-height: 1.6; }.save-path span { overflow-wrap: anywhere; }
.document-plan { margin-top: 5px; padding: 17px; border: 1px solid var(--line); border-radius: 8px; @apply bg-subtle; }.document-plan h4 { margin: 0 0 10px; font-size: var(--jm-font-size-body); }.planned-document { display: flex; align-items: center; gap: 10px; min-height: 43px; @apply text-ink-700; }.planned-document > svg { flex: none; @apply text-accent; }.planned-document strong { flex: none; min-width: 50px; }.planned-document span { flex: 1; min-width: 0; overflow-wrap: anywhere; @apply text-ink-500; font-size: var(--jm-font-size-callout); }
.document-fields { display: grid; grid-template-columns: minmax(0, 1fr) minmax(160px, .7fr); gap: 16px; }.document-fields select { width: 100%; }.import-settings { display: flex; flex-wrap: wrap; align-items: center; gap: 12px 20px; }.import-settings label { display: flex; align-items: center; gap: 8px; @apply text-ink-700; }.import-settings > button { margin-left: auto; }.segmentation-help { margin: -6px 0 0; @apply text-ink-500; font-size: var(--jm-font-size-callout); line-height: 1.7; }
.text-button { display: inline-flex; align-items: center; justify-content: center; gap: 6px; min-height: 30px; padding: 4px 5px; border: 0; border-radius: 4px; @apply text-accent-strong; background: transparent; cursor: pointer; }.text-button:hover:not(:disabled) { @apply bg-hover; }.remove-document { align-self: flex-start; @apply text-ink-500; }
.project-summary { display: grid; gap: 9px; padding: 17px; border-radius: 8px; @apply bg-green-soft; }.project-summary strong { @apply text-accent-strong; font-size: var(--jm-font-size-title-3); }.project-summary span { @apply text-ink-700; overflow-wrap: anywhere; line-height: 1.6; }.document-summary { padding: 13px 16px; border: 1px solid var(--line); border-radius: 8px; }.document-summary-heading { display: flex; align-items: center; gap: 10px; }.document-summary-heading > span { flex: none; padding: 4px 6px; border-radius: 4px; @apply text-ink-700 bg-subtle; font-size: var(--jm-font-size-callout); }.document-summary h4 { margin: 0; overflow-wrap: anywhere; font-size: var(--jm-font-size-body); }.document-summary button { margin-left: auto; flex: none; }.document-summary p { margin: 6px 0 11px; overflow-wrap: anywhere; @apply text-ink-500; font-size: var(--jm-font-size-callout); }.document-summary ul { display: flex; flex-wrap: wrap; align-items: center; gap: 9px 16px; margin: 0; padding: 0; list-style: none; @apply text-ink-700; font-size: var(--jm-font-size-callout); }.segment-count { display: inline-flex; align-items: center; gap: 5px; @apply text-accent-strong; }.creation-note { margin: 0; @apply text-ink-500; line-height: 1.7; }
.wizard-error { margin: 18px 0 0; padding: 12px 14px; border: 1px solid var(--line); border-radius: 7px; @apply text-ink-900 bg-danger-soft; overflow-wrap: anywhere; line-height: 1.65; }
.wizard-footer { justify-content: flex-end; border-top: 1px solid var(--line); }.footer-progress { margin-right: auto; @apply text-ink-500; font-size: var(--jm-font-size-callout); }.primary-button, .secondary-button { display: inline-flex; align-items: center; justify-content: center; gap: 6px; min-height: 38px; padding: 0 16px; border-radius: 7px; cursor: pointer; }.primary-button { border: 1px solid var(--green-900); @apply text-white bg-accent-solid; }.secondary-button { border: 1px solid var(--line); @apply text-ink-700 bg-raised; }
