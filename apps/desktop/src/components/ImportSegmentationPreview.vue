...
.preview-encoding span { color: var(--ink-500); }
.import-preview { min-width: 0; border: 1px solid var(--line); border-radius: 8px; overflow: hidden; background: var(--surface-raised); }
...
.preview-summary strong { color: var(--green-900); }.preview-summary span { min-width: 0; overflow-wrap: anywhere; color: var(--ink-700); }.preview-summary small { color: var(--ink-500); }
.preview-message { display: flex; min-height: 180px; flex-direction: column; align-items: center; justify-content: center; gap: 12px; padding: 24px; text-align: center; color: var(--ink-500); }.preview-message p { margin: 0; overflow-wrap: anywhere; }.preview-message--error { color: #a24c4c; background: var(--surface-danger-soft); }
button { display: inline-flex; min-width: 30px; min-height: 30px; align-items: center; justify-content: center; gap: 6px; padding: 4px 9px; border: 1px solid var(--line); border-radius: 6px; color: var(--ink-700); background: var(--surface-raised); cursor: pointer; }
.preview-warning { margin: 0; padding: 10px 14px; color: var(--ink-700); background: var(--surface-warm-soft); line-height: 1.5; }
.preview-columns, .preview-comparison { display: grid; grid-template-columns: minmax(0, 1fr) 20px minmax(0, 1fr); gap: 10px; }.preview-columns { padding: 9px 14px; color: var(--ink-500); background: var(--surface-subtle); font-size: var(--jm-font-size-callout); }
.preview-rows { max-height: 330px; overflow: auto; overscroll-behavior: contain; }.preview-row { padding: 12px 14px; border-top: 1px solid var(--line); }.preview-row header { display: flex; flex-wrap: wrap; gap: 8px 12px; align-items: baseline; margin-bottom: 9px; }.preview-row header strong { color: var(--green-900); white-space: nowrap; }.preview-row header span { color: var(--ink-700); font-size: var(--jm-font-size-callout); line-height: 1.5; }
.preview-comparison { align-items: center; }.preview-comparison svg { color: var(--ink-500); }.preview-comparison pre { align-self: stretch; max-height: 160px; overflow: auto; margin: 0; padding: 10px; border-radius: 5px; background: var(--surface-subtle); color: var(--ink-700); font: inherit; line-height: 1.65; white-space: pre-wrap; overflow-wrap: anywhere; }.preview-comparison .preview-result { color: var(--ink-900); background: var(--surface-green-soft); }
.preview-cleanups { display: flex; flex-wrap: wrap; gap: 6px; margin: 9px 0 0; padding: 0; list-style: none; }.preview-cleanups li { padding: 3px 6px; border-radius: 4px; color: var(--green-900); background: var(--surface-green-soft); font-size: var(--jm-font-size-subheadline); line-height: 1.5; }.preview-unchanged { margin: 8px 0 0; color: var(--ink-500); font-size: var(--jm-font-size-subheadline); }
.preview-pagination { display: flex; align-items: center; gap: 10px; padding: 10px 14px; border-top: 1px solid var(--line); color: var(--ink-500); font-size: var(--jm-font-size-callout); }.preview-pagination > span:first-child { margin-right: auto; }
